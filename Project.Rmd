...
Elapsed time is around 74 seconds.
...
```
Best cross-validation's minimum error rate `test.merror.mean` is around 0.0058 (0.6%), happened at 151st iteration.   
...
```{r fig.width=8, fig.height=12, dpi=72,eval=FALSE}
